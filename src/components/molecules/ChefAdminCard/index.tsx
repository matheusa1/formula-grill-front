...
import { TChefAdminCard } from './types'
import Image from 'next/image'
import { Pencil, X } from 'lucide-react'
import * as Dialog from '@radix-ui/react-dialog'
import CreateChefForm from '../CreateChefForm'

const ChefAdminCard: FC<TChefAdminCard> = ({ chefsInfo }) => {
    ...
    >
      ...
      <div className="col-span-2 flex w-full flex-col justify-between">
        ...
        <p className="flex w-full gap-2 text-ellipsis whitespace-nowrap">
          ...
          {chefsInfo.yearsOfExperience} anos
        </p>
